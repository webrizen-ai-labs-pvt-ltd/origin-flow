...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-secondary bg-primary/80 px-6 backdrop-blur-xl shrink-0">
