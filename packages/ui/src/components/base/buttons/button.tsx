    ...
    const commonChildren = (
        <>
            ...
            {isReactComponent(IconLeading) && (() => {
                const Comp = IconLeading as any;
                return <Comp data-icon="leading" className={styles.common.icon} />;
            })()}
            ...
            {isReactComponent(IconTrailing) && (() => {
                const Comp = IconTrailing as any;
                return <Comp data-icon="trailing" className={styles.common.icon} />;
            })()}
        </>
    );
